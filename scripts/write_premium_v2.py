...
import os
path = os.path.join(os.path.dirname(__file__), '..', 'src', 'components', 'analytics', 'AnalyticsPremium.jsx')
path = os.path.normpath(path)
with open(path, 'w') as f:
    f.write(content.lstrip())
print(f"AnalyticsPremium.jsx written: {len(content.splitlines())} lines")
